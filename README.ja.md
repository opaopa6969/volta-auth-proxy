...
| volta-sdk ([Java](docs/glossary/java.ja.md)) | [Javalin](docs/glossary/javalin.md) ミドルウェアで [JWT](docs/glossary/jwt.ja.md) 検証 |
...
6. [Client](docs/glossary/client.md) ID と Client Secret を [`.env`](docs/glossary/environment-variable.ja.md) にコピー
