...
| **[App 連携](docs/glossary/app-integration.ja.md)** | [ForwardAuth](docs/glossary/forwardauth.ja.md) + [Internal API](docs/glossary/internal-api.ja.md) | 汎用 [OIDC](docs/glossary/oidc.ja.md) | [SDK](docs/glossary/sdk.ja.md) | 汎用 OIDC | [Oathkeeper](docs/glossary/oathkeeper.ja.md) |
...
| ログアウト | 単一デバイス・全デバイス対応。[JWT](docs/glossary/jwt.ja.md) 有効期限（最大 5 分）で伝播 |
...
| [テナント](docs/glossary/tenant.ja.md)切替 | [セッション](docs/glossary/session.ja.md)中に [API](docs/glossary/api.ja.md) で切替。ページリロードでクリーンな状態に |
...
| [App](docs/glossary/downstream-app.ja.md) 別制御 | volta-config.yaml で [App](docs/glossary/downstream-app.ja.md) ごとに許可[ロール](docs/glossary/role.ja.md)を定義。[ForwardAuth](docs/glossary/forwardauth.ja.md) で強制 |
...
| 機能 | 詳細 |
|------|------|
| [ForwardAuth](docs/glossary/forwardauth.ja.md) | [App](docs/glossary/downstream-app.ja.md) は [HTTP](docs/glossary/http.ja.md) [ヘッダ](docs/glossary/header.ja.md)から identity を取得。認証コードゼロ |
...
| [セッション](docs/glossary/session.ja.md)管理 | 全アクティブ[セッション](docs/glossary/session.ja.md)表示、個別/一括失効 |
...
4. 該当なし → [招待](docs/glossary/invitation-flow.ja.md)コード入力 or [テナント](docs/glossary/tenant.ja.md)選択画面
