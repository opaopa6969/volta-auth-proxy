...
|---|---|---|---|---|
| フロー定義 | 管理 UI | ビジュアルエディタ | Rules/Actions | **コード** ([tramli](https://github.com/opaopa6969/tramli)) |
...
全ての[認証](docs/glossary/authentication-vs-authorization.ja.md)フローは **[tramli](https://github.com/opaopa6969/tramli)** — 制約付き[ステートマシン](docs/glossary/state-machine.ja.md)エンジンで駆動。不正な遷移が構造的に存在できない。以下の図は `MermaidGenerator.generate(definition)` で**コードから自動生成** — 古くなることがない。
