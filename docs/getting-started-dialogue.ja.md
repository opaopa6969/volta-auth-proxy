...
**リン:** 4 行。volta が [Traefik](glossary/traefik.md) の設定を自動生成する。
...
**リン:** volta-[sdk](glossary/sdk.md)-js を入れる。script タグ 1 つ。
...
**カイ:** もう一つ。[Traefik](glossary/traefik.md) 使ってないんだけど、必須？

**リン:** いいえ。[Traefik](glossary/traefik.md) は推奨だけど必須じゃない。3 つの選択肢がある:
...
**リン:** そう。A で始めて、本番で [Traefik](glossary/traefik.md) を追加する。
