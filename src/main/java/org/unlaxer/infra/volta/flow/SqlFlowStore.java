        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    ...
                    String exitState = rs.getString("exit_state");

                    var flow = FlowInstance.restore(flowId, sessionId, definition, ctx, state,
                            createdAt, expiresAt, guardFailures, version, exitState);
